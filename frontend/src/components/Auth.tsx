...
export default function Auth() {
  ...
  if (user) {
    return (
      <div className="flex items-center gap-3">
        {migrationStatus && (
          <div className="px-2 py-1 text-xs bg-green-100 text-green-700 rounded-lg border border-green-200 animate-pulse hidden sm:block">
            {migrationStatus}
          </div>
        )}
        {migrating && (
          <div className="px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded-lg border border-blue-200 hidden sm:block">
            ⏳ Migration...
          </div>
        )}
        <div className="flex items-center gap-2.5 bg-white border border-gray-200 rounded-lg px-3 py-2 shadow-sm hover:shadow-md transition-all">
          {/* Avatar Google */}
  ...
  return (
    <button
      ...
      disabled={loading}
      className="group relative px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:from-blue-600 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2.5 font-medium shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95"
    >
      <div className="flex items-center justify-center w-5 h-5 bg-white rounded-full p-0.5">
