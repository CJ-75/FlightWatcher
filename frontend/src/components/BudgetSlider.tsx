  ...
  return (
    <div className="mb-8">
      ...
      <motion.div
        ...
        className="text-3xl sm:text-4xl font-black text-primary-500 mb-2"
      >
        {value}€
      </motion.div>
      <div className="relative">
        <input
          ...
          className="w-full h-3 sm:h-4 bg-slate-200 rounded-full appearance-none cursor-pointer
                     ...
                     [&::-moz-range-thumb]:w-6 [&::-moz-range-thumb]:h-6 sm:[&::-moz-range-thumb]:w-8 sm:[&::-moz-range-thumb]:h-8 
                     [&::-moz-range-thumb]:bg-white [&::-moz-range-thumb]:border-4 [&::-moz-range-thumb]:border-primary-500 
                     [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:shadow-xl"
          style={{
